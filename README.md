...
현재는 타입에 적응하고 싶어 모든 곳에 타입을 정하는 식이지만 후에 타입 추론을 잘 활용하여 필요한 곳에만 넣을 수 있는 실력이 되면 좋겠습니다.#   r o c k s c i s s o r s p a p e r - 2 0 2 3 
 
 
